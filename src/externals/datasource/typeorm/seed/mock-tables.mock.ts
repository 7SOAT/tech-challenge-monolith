...
import ProductGateway from "package/gateways/product.gateway";
import OrderStatusGateway  from "package/gateways/order-status.gateway";
import OrderGateway from "package/gateways/order.gateway";
